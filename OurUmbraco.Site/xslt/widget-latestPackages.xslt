...
<!--
	widget-latestPackages.xslt
	
	Renders the list of newest projects on the frontpage of Our
-->
...
>
	...
	<!-- Projects start here -->
	<xsl:variable name="projectsRoot" select="umbraco.library:GetXmlNodeById($source)" />

	<xsl:template match="/">
		<ul class="projects summary">
			<xsl:for-each select="$projectsRoot//Project[projectLive = 1]">
