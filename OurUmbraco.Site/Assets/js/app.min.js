...
jQuery(document).ready(function(){$(".package-compatibility-versions").each(function(){var el=$(this),id=el.data("id"),file=el.data("file");$.get("/html/versioncompatibilityreport?fileId="+file+"&packageId="+id,function(response){el.html(response)})})});
