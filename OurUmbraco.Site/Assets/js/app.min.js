...
jQuery(document).ready(function (){
		...
		//project search
		$('.project-search-input').keyup(function(ev) {
				...
				$.ajax({
				  ...
				  success: function(response){
				  	...
				  	_.each(response.items, function(item){
				  		...
				  		var image = item.Fields.image.length > 0 ? item.Fields.image : "<i class='icon-Box'></i>";
				  		var itemData = {	
			...
			if(term.length > 3){
				...
				$.ajax({
				  ...
				  success: function(response){
				  	...
				  	var linkhtml = '<li class="search-view-all"><a href="/search?q=' + response.term + '">View All ' + response.total + ' results</a></li>';
