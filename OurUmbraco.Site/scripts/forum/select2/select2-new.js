    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        selectChoice: function (choice) {
            ...
            if (selected.length && choice && choice[0] == selected[0]) {
                ...
                this.opts.element.trigger("choice-deselected", { element: selected, data: selected.data("select2-data") });
                selected.removeClass("select2-search-choice-focus");
                if (choice && choice.length) {
                    this.close();
                    choice.addClass("select2-search-choice-focus");
                    this.opts.element.trigger("choice-selected", { element: choice, data: choice.data("select2-data") });
                }
            }
        },
        ...
        initContainer: function () {
            ...
            this.selection.on("mousedown", ".select2-search-choice", function (e) {
                ...
                _this.selectChoice(choice);

                _this.opts.element.trigger("choice-begin-edit", { element: choice, data: choice.data("select2-data") });

            })
                .append("<li class='select2-search-choice'></li>") //Add a floating LI to convince sortable that the choices are floating
                .sortable({
                    items: " > li.select2-search-choice",
                    tolerance: "pointer",
                    revert: 100
                })
                .remove("li.select2-search-choice");
            ...
            this.search.bind("keydown", this.bind(function (e) {
                ...
                setTimeout(function () { _this.resizeSearch(); });
                ...
                if (selected.length) {
                    var ev = $.extend({}, e, { type: "choice-keydown" });

                    this.opts.element.trigger(ev, { element: selected, data: selected.data("select2-data") });
                    if (ev.isDefaultPrevented()) {
                        this.handledByChoice = true;
                        killEvent(e);
                        return;
                    }
                }
                if (selected.length &&
                    ...
                    if (e.which == KEY.LEFT && prev.length) {
                        ...
                        this.opts.element.trigger("choice-begin-edit", { element: selected, data: selected.data("select2-data") });
                        //selectedChoice = null;
                    }
            ...
            this.container.delegate("*", "keydown", this.bind(function (e) {
                if (e.which == KEY.ENTER || e.which == KEY.ESC) {
                    var _this = this;
                    var choice = this.container.find(".select2-search-choice-focus");
                    if (choice.length) {
                        this.opts.element.trigger("choice-end-edit", { element: choice, data: choice.data("select2-data") });
                        this.search[0].focus();
                        _this.selectChoice(choice);
                        //setTimeout(function () { _this.selectChoice(choice); }, 1);
                        killEvent(e);
                    }
                }
            }));
            this.container.delegate(selector, "focus", this.bind(function (e) {
                if (!this.enabled) return;

                var choice = $(e.target).closest(".select2-search-choice");
                if (choice.length) {
        ...
        addSelectedChoice: function (data) {
            ...
            if (formatted != undefined) {
                choice.find("div").replaceWith("<div class='caption' title='" + this.opts.escapeMarkup(formatted) + "'>" + this.opts.escapeMarkup(formatted) + "</div>");
            }
            ...
            val.push(id);
            this.setVal(val);
            this.opts.element.trigger("choice-created", { element: choice, data: data });
        },
