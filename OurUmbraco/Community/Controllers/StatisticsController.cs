...
namespace OurUmbraco.Community.Controllers
{
    public class StatisticsController : SurfaceController
    {
        ...
        {
            var karmaRecentStatistics = ApplicationContext.ApplicationCache.RuntimeCache.GetCacheItem<PeopleData>("OurRecentKarmaStatistics",
                () =>
                {
            ...
            var karmaYearStatistics = ApplicationContext.ApplicationCache.RuntimeCache.GetCacheItem<PeopleData>("OurYearKarmaStatistics",
                () =>
                {
